...
cat = catboost.CatBoostClassifier(n_estimators=1000, learning_rate=0.03, depth=7, task_type='GPU')
...
submit.to_csv('second2.csv',index=False)
print("Saved to csv!")
...
#
final_xgb_model = xgb.XGBClassifier(**final_xgb_model_params, n_jobs=-1, tree_method='gpu_hist', grow_policy="lossguide", sampling_method="gradient_based", update="prune")
